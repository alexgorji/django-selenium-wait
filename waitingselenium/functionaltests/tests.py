...
class TestWait(FunctionalTest):
    def test_do_not_scroll_down_and_wait(self):
        ...
        wait.until(lambda d: self.driver.find_element(By.ID, "id_success").is_displayed())
        self.driver.find_element(By.ID, "id_success").click()
        assert self.driver.title == 'demo success'
